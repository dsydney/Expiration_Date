...
@Composable
fun ViewPhotoScreen(myPhoto: File) {
    Scaffold(
        modifier = Modifier.fillMaxSize(),
        topBar = { TopAppBar(title = { Text(text = "View your photos") })},
        content = {
            Text(text = "$myPhoto")
            //Image(painter = painterResource(id = myPhoto), contentDescription = "")
        }
    )
}